...
// --------------------------------
import org.sapia.domain.dublincore.Language;
 ...
 * @version 1.0
 */
public class LanguageHandlerState extends AbstractDublinCoreHandlerState {
  /////////////////////////////////////////////////////////////////////////////////////////
  /////////////////////////////////  INSTANCE ATTRIBUTES  /////////////////////////////////
  /////////////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Creates a new LanguageHandlerState instance.
   */
  public LanguageHandlerState() {
    _isParsing           = false;
  ...
  public void startElement(HandlerContextIF aContext, String anUri,
    ...
    if (ELEMENT_LANGUAGE.equals(aLocalName)) {
      _isParsing = true;

      String anXmlLanguageCode = ParserUtil.extractXmlLanguageCode(someAttributes);
      _theLanguage = new Language("", anXmlLanguageCode);
    }
  }
  ...
  public void endElement(HandlerContextIF aContext, String anUri,
    ...
    if (ELEMENT_LANGUAGE.equals(aLocalName)) {
      _theLanguage.setValue(_theElementContent.toString());
      _isParsing = false;
    }
  }
