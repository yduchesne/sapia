...
// --------------------------------
import org.sapia.domain.dublincore.parser.SourceHandlerState;
 ...
 * @version 1.0
 */
public class SourceHandlerStateTest extends TestCase {
  ...
  private static final String ELEMENT_VALUE = "Sapia Open Community";
  ...
  private static final String INVALID_NAMESPACE_ELEMENT =
      "<dc:source xmlns:dc=\"http://another.org/dc/elements/1.1/\">" +
          ELEMENT_VALUE +
      "</dc:source>";

  /** Defines the a unqualified xml:lang valid test case. */
  private static final String UNQUALIFIED_XMLLANG_VALID_ELEMENT =
      "<dc:source xmlns:dc=\"http://purl.org/dc/elements/1.1/\" xml:lang=\"en-US\">" +
          ELEMENT_VALUE +
      "</dc:source>";
  ...
  private static final String QUALIFIED_XMLLANG_VALID_ELEMENT =
      "<dc:source xmlns:x=\"http://www.w3.org/XML/1998/namespace\" xmlns:dc=\"http://purl.org/dc/elements/1.1/\" x:lang=\"en-US\">" +
          ELEMENT_VALUE +
      "</dc:source>";
  ...
  public static void main(String[] args) {
    TestRunner.run(SourceHandlerStateTest.class);
  }

  private SourceHandlerState _theHandlerState;
  private StatefullSAXHandler _theSAXHandler;

  /**
   * Creates a new SourceHandlerStateTest instance for the
   * test case name passed in.
   */
  public SourceHandlerStateTest(String aName) {
    super(aName);
  }
  ...
  public void setUp() {
    ...
    _theHandlerState = new SourceHandlerState();
  ...
  public void testUnqualifiedValidElement() throws Exception {
    ...
    assertNotNull("The result of the SourceHandlerState should not be null", _theHandlerState.getResult());
    assertEquals("The value of the Source object is invalid", ELEMENT_VALUE, _theHandlerState.getResult().getValue());
