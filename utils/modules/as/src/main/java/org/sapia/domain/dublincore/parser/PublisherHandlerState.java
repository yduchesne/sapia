...
// --------------------------------
import org.sapia.domain.dublincore.Publisher;
 ...
 * @version 1.0
 */
public class PublisherHandlerState extends AbstractDublinCoreHandlerState {
  /////////////////////////////////////////////////////////////////////////////////////////
  /////////////////////////////////  INSTANCE ATTRIBUTES  /////////////////////////////////
  /////////////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return The result Publisher object of this handler state.
  ...
  public void startElement(HandlerContextIF aContext, String anUri,
    ...
    if (ELEMENT_PUBLISHER.equals(aLocalName)) {
      _isParsing = true;

      String anXmlLanguageCode = ParserUtil.extractXmlLanguageCode(someAttributes);
      _thePublisher = new Publisher("", anXmlLanguageCode);
    }
  }
  ...
  public void endElement(HandlerContextIF aContext, String anUri,
    ...
    if (ELEMENT_PUBLISHER.equals(aLocalName)) {
      _thePublisher.setValue(_theElementContent.toString());
      _isParsing = false;
    }
  }
