...
> | ` [root@cygnus-mandriva init.d]# chkconfig --add corus `<br />` [root@cygnus-mandriva init.d]#` |
|:------------------------------------------------------------------------------------------------|
