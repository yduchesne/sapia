 ...
 * </dl>
 */
public class Dom4jProcessorCompositeTest extends TestCase {
  ...
  private Dom4jProcessor _theProcessor;

  public static void main(String[] args) {
    TestRunner.run(Dom4jProcessorCompositeTest.class);
  }

  public Dom4jProcessorCompositeTest(String aName) {
    super(aName);
  }
  ...
  public void setUp() {
    ...
    _theProcessor = new Dom4jProcessor(anObjectFactory);
  }
