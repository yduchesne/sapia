...
public class Hub {
   ...
   *
   * @param object the {@link Object} to export.
   * @param props the transport provider {@link Properties}.
   ...
   * @param object an {@link Object} to export.
   ...
   * this class, call the latter's {@link #shutdown()} method.
   *
   * @see #shutdown(long)
   *
   ...
   * the <code>Hub</code>, call the latter's {@link #shutdown} method.
   *
   * @see #shutdown(long)
   *
   * @param loader
   ...
   *
   * @param address the {@link ServerAddress} corresponding to the target server's
   * physical endpoint.
   *
   * @throws RemoteException if a problem occurs performing the connection.
   */
