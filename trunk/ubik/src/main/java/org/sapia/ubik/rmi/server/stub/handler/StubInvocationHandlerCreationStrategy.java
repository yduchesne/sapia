 ...
 */
public interface StubInvocationHandlerCreationStrategy {
  
  /**
   * @param toExport the {@link Object} for which a stub (dynamic proxy) is to be created. 
   * @return <code>true</code> if this instance can create a {@link StubInvocationHandler}
  ...
  /**
   * @param toExport the {@link Object} for which a stub (dynamic proxy) is to be created.
   * @param context the {@link RemoteRefContext} that the {@link StubInvocationHandler} that
   * will be created by this method should wrap.
   * @return the {@link StubInvocationHandler} that was created.
   * @throws Exception if a problem occurs creating the invocation handler.
   */
