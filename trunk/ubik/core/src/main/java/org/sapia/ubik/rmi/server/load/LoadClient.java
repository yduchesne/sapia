...
/**
 * Looks up a {@link LoadService} from the JNDI and calls it non-stop, according
 * to user-provided parameters. Type <code>-h</code> at the command-line to
 * start.
 * <p>
 * You can start a {@link LoadClient} with the <code>starter.sh</code> script
 ...
 * </pre>
 * 
 * Another example, starting a {@link LoadClient} that connects to the JNDI
 * server on <code>localhost:1099</code> and loads properties from the specified
 * file:
 * 
 * <pre>
 ...
 * Notes:
 * <ul>
 * <li>You can specify additional classpath information, through the
 * <code>UBIK_CP</code> environment variable. The value of that variable is
 * expected to hold the path to additional librairies, if relevant.
 * <li>You can specify custom JVM options with the <code>UBIK_OPTS</code>
...
public class LoadClient {
  ...
  public static void main(String[] args) throws Exception {
    ...
    final Counter callsPerSecond = Stats.createCounter(LoadClient.class, "ClientRemoteMethodCalls", "The number of remote method calls");
    final Stopwatch callDuration = Stats.createStopwatch(LoadClient.class, "ClientRemoteMethodCallDuration", "Remote method call duration");
