...
/**
 * A convenience class that can be used to export remote objects through the NIO
 * TCP transport (see {@link MinaTransportProvider}).
 * 
 * @author yduchesne
 * 
 */
public class MinaServerExporter {
   ...
   *         Defaults to {@link Consts#DEFAULT_MARSHALLING_BUFSIZE}.
   */
  ...
  /**
   * @return the maximum number of worker threads that should be used by servers
   *         through which the remote objects this instance creates are exported
   *         (no maximum is defined by default).
   */
  ...
  public String toString() {
    return Strings.toString("port", port, "bindAddress", bindAddress, "bufferSize", bufferSize, "maxThreads", maxThreads);
  }
}
