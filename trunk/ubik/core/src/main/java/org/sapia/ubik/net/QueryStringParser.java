...
/**
 * Parses query strings to object representations. It can be used to create
 * {@link QueryString} or {@link Name} instances.
 * <p>
...
public class QueryStringParser implements NameParser {
   ...
   *          a query string.
   * 
   * @return an <code>Enumeration</code> containing the separate paths that make
   *         the given query string; if the given name has trailing name-value
   *         pairs has attributes, the latter are concatenated to the last path.
   *         Thus, the following string:
   *         <code>some/object?prop1=value1&prop2=value2</code> would have
   *         <code>object?prop1=value1&prop2=value2</code> as its last path
   *         string.
   */
  ...
  /**
   * Parses the given query string into a <code>javax.naming.Name</code>
   * instance. The query string's parameters are part of the last element in the
