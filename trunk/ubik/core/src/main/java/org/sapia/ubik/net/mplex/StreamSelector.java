...
/**
 * This interface derfines the contract of a selector that defines, from a
 * preview of a stream of data, if it can handle the entire stream or not. This
 * interface is used by the <code>MultiplexServerSocket</code> to determine
 * which socket connector will handle a new socket connection.
 * 
