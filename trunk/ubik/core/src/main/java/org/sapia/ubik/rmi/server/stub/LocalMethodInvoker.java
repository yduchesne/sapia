...
/**
 * An instance of this interface is meant to invoke methods of remote stubs that are not meant for being called
 * remotely, such as <code>toString()</code>, <code>equals()</code>, <code>hashCode()</code>, etc.
 * 
 * @author yduchesne
 *
 */
public interface LocalMethodInvoker {
  ...
  /**
   * @param handler the {@link StubInvocationHandler} that received the given method.
   * @param params the parameters that were received for the method.
   * @return the {@link Object} corresponding to the method's return value.
   * @throws Throwable if an error occurs while handling the method's invocation.
   */
  public Object invoke(StubInvocationHandler handler, Object[] params) throws Throwable;
}
