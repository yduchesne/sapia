...
/**
 * This class is the implementation of client socket that is used in Ubik's
 * multiplex logic. It extends the traditionnal {@link Socket} of the
 * <code>java.net</code> package to add a read-ahead functionality on the input
...
public class MultiplexSocket extends Socket {
  ...
  /**
   * The size of the number of the maximum number of bytes that can be
   * read-ahead.
   */
   ...
   * 
   * @param impl
   *          The socket impl to use.
   * @param bufferSize
   *          The maximum read-ahead buffer size.
   * @throws SocketException
   *           If an error occurs with the socket impl.
   */
  public MultiplexSocket(SocketImpl impl, int bufferSize) throws SocketException {
    super(impl);
  ...
  public InputStream getInputStream() throws IOException {
    if (_theInput == null) {
      _theInput = new PushbackInputStream(new BufferedInputStream(super.getInputStream()), _thePushbackBufferSize);
    }
  ...
  /**
   * Returns the input stream of this socket as a
   * <code>PushbackInputStream</code>.
   * 
   * @return The input stream of this socket as a
   *         <code>PushbackInputStream</code>.
   */
