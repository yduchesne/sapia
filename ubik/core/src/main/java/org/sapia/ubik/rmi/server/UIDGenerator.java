...
/**
 * A generator of unique longs for this VM. Note that the internal counter is cyclic:
 * it will be reset when the maximum UID will have been reached. This class should thus
 * not be used to generate IDs that are meant for persistence.
 *
