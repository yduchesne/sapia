...
public class BlockingCompletionQueue<T> {
  ...
  /**
   * Waits until all expected items have been added to this queue, or until the given
   * timeout is reached.
   * 
   * @param timeout the maximum amount of time that this instance should wait until this
   * instance's items are returned.
