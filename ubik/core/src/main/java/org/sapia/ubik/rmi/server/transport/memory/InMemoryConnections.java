...
/**
 * Implements the {@link Connections} interface by creating instances of {@link InMemoryRequestConnection}.
 * 
 * @author yduchesne
 *
 */
public class InMemoryConnections implements Connections {
  ...
  /**
   * @param useMarshalling <code>true</code> if the connections used by this instance should marshal their data,
   * <code>false</code> otherwise.
   * @param address the {@link InMemoryAddress} corresponding to the {@link InMemoryServer} to which this
   * instance should create connections to.
   * @param provider the {@link InMemoryTransportProvider} to which this instance corresponds.
   */
