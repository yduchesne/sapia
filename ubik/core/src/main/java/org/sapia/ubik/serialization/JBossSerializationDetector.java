 ...
 * required library being found in the classpath, and if the
 * {@link Consts#SERIALIZATION_PROVIDER} system property does not specify
 * otherwise.
 * 
 * @author yduchesne
 * 
...
public final class JBossSerializationDetector {
  ...
  /**
   * @return <code>true</code> if the JBoss serialization library has been
   *         detected and should used.
   */
