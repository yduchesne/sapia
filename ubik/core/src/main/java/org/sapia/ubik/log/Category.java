...
/**
 * A {@link Category}, which can be used instead of using the {@link Log} class directly. 
 * It is more convenient to use an instance of this class, since it spares passing the 
 * origin of the log at every method call.
 * <p>
 * Also, an instance of this class provides methods allowing for format specifiers and
 * arguments, such as in {@link String#format(String, Object...)}.
 * 
 * @author yduchesne
 */
