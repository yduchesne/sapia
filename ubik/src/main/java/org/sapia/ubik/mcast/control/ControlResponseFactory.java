...
public class ControlResponseFactory {
	...
	/**
	 * @param code the response {@link Code} of the challenge response to return.
	 * @param request the {@link ControlRequest} for which to create a response.
	 * @param address the unicast {@link ServerAddress} of the node that is sending the response.
s	 * @return a new {@link ChallengeResponse}.
	 */ 
	...
	/**
	 * @param originNode the node from which the ping response is sent.
