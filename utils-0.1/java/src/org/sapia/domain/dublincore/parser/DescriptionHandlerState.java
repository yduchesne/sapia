...
// --------------------------------
import org.sapia.domain.dublincore.Description;
 ...
 * @version 1.0
 */
public class DescriptionHandlerState extends AbstractDublinCoreHandlerState {
  /////////////////////////////////////////////////////////////////////////////////////////
  /////////////////////////////////  INSTANCE ATTRIBUTES  /////////////////////////////////
  /////////////////////////////////////////////////////////////////////////////////////////
  ...
  private Description _theDescription;
  ...
  /**
   * Creates a new DescriptionHandlerState instance.
   */
  public DescriptionHandlerState() {
    _isParsing           = false;
  ...
  public void startElement(HandlerContextIF aContext, String anUri,
    ...
    if (ELEMENT_DESCRIPTION.equals(aLocalName)) {
      _isParsing = true;

      String anXmlLanguageCode = ParserUtil.extractXmlLanguageCode(someAttributes);
      _theDescription = new Description("", anXmlLanguageCode);
    }
  }
  ...
  public void endElement(HandlerContextIF aContext, String anUri,
    ...
    if (ELEMENT_DESCRIPTION.equals(aLocalName)) {
      _theDescription.setValue(_theElementContent.toString());
      _isParsing = false;
    }
  }
