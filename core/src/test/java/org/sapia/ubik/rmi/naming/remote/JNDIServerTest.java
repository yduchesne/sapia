...
public class JNDIServerTest {
  ...
  public void testFileArg() {
    JNDIServer.Args args = JNDIServer.parseArgs(new String[] { "-f",
        System.getProperty("user.dir") + File.separator + "etc" + File.separator + "test" + File.separator + "jndiServer.properties" }, false);
    assertEquals("test", args.properties.getProperty(Consts.UBIK_DOMAIN_NAME));
  }
