...
/**
 * A concurrent utility that implements synchronized set/get primitives
 * on an object reference.
 * 
 * @author yduchesne
 *
 * @param <T> the generic type of the object to synchronize
 */
public class SynchronizedRef<T> {
	...
	/**
	 * @param ref an object to assign to this instance.
	 */
	...
	/**
	 * @return <code>true</code> if this instance's object is NOT <code>null</code>.
	 */	
