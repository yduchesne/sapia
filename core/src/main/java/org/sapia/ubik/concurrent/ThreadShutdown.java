...
public class ThreadShutdown {
  ...
  /**
   * @param delay
   *          the delay between each attempt, in millis.
   ...
   * 
   * @param maxAttempts
   *          the maximum number of attempts that this instance should try
   *          interrupting the thread that it holds.
   * 
   * @return this instance.
   */
  ...
  /**
   * Attempts interrupting the thread that this instance holds, up to the
   * configured maximum number of attempts.
   * 
   * @throws InterruptedException
   *           if the calling thread is itself interrupted while performing this
   *           operation.
   */
  ...
  /**
   * Same as {@link #shutdown()}, except that no {@link InterruptedException} is
   * thrown if the calling thread is itself interrupted while performing the
   * shutdown.
   */
