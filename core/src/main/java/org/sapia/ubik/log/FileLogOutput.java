 ...
 * name, which is set to "ubik". This means that the current log file will be named as follows:
 * 
 * <pre>
 *  ubik.log
 * </pre>
...
public class FileLogOutput extends BaseFileLogOutput{
   ...
   * (<code>ubik.rmi.log.file.name</code>). Defaults to <code>ubik</code>.
   */
   ...
   * (<code>ubik.rmi.log.file.size</code>). Defaults to 3 megabytes.
   */
