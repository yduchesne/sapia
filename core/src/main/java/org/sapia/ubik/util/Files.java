...
public final class Files {
  ...
  public interface FileVisitor {
    ...
    /**
     * @param visited the {@link File} being visited.
     * @return <code>true</code> if traversal should continue, <code>false</code> if
     * it should stop.
     */
   ...
   * that are visited are added to the internal list of files that an instance of
   * this class internally keeps, provided they are accepted by the {@link FileFilter} that
   * the instance of this class wraps.
   * 
   * @see FileFilter
   * 
   * @author yduchesne
  ...
  public static class FileFilterVisitor implements FileVisitor {
    ...
    /**
     * @param filter the {@link FileFilter} that this instance should use.
     */
    ...
    /**
     * Adds the given file to this instance's internally kept list if it is accepted
     * by this instance's {@link FileFilter}.
     */
    @Override
    public boolean visit(File visited) {
    ...
    /**
     * @return the {@link List} of {@link File}s that have been accumulated by this instance.
     */
  ...
  /**
   * A {@link FileVisitor} that deletes the files it visits: should be used in conjunction with
   * {@link Files#visitDepthFirst(File, FileVisitor)}.
   */
  ...
  /**
   * Visits a file hierarchy, starting from the given root directory. The algorithm implements
   * depth-first traversal.
   * 
   * @param rootDir a {@link File} corresponding to the root directory of the hierarchy to traverse.
   * @param visitor a {@link FileVisitor}
   */
   ...
   * 
   * @param filter the {@link FileFilter} with which the {@link FileFilterVisitor} should 
   * be constructed.
