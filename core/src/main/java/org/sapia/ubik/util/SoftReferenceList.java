...
/**
 * Encapsulates list elements in {@link SoftReference}s. Automatically manages <code>null</code> references by
 * removing them from this instance's internal list at iteration time.
 * <p>
...
public class SoftReferenceList<T> implements Iterable<T> {
  ...
  /**
   * @param item an item to add to this list.
   */
  ...
  /**
   * @param toRemove the item to remove from this list.
   * @return <code>true</code> if the given object was found and removed, or <code>false</code> if it is 
   * not contained in this instance and therefore could not be removed.
   */
  ...
  /**
   * @return this instance's approximate size (calculated without checking for <code>null</code> soft references).
   */
  ...
  /**
   * @param toCheck the object to check for containment in this instance.
   * @return <code>true</code> if the given object is contained in this instance.
   */
