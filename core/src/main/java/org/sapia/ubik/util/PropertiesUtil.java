...
public final class PropertiesUtil {
  ...
  /**
   * @param props
   *          the {@link Properties} into which the properties contained in the
   *          given file should be loaded.
   * @param file
   *          a {@link File} to load properties from.
   * @throws IOException
   ...
   * 
   * @param from
   *          the {@link Properties} instance to copy from.
   * @param to
   *          the {@link Properties} instance to copy to.
   */
  ...
  /**
   * @param toClear
   *          the {@link Properties} to clear.
   * @param condition
   *          the {@link Condition} upon which a given property will be cleared,
   *          if that condition is <code>true</code>.
   */
   ...
   * @param name
   *          a property name.
   * @return <code>true</code> if the value of the system property with the
   *         given name is <code>true</code>.
   */
   ...
   * @param name
   *          a property name.
   * @return <code>false</code> if the value of the system property with the
   *         given name is <code>false</code>.
   */
