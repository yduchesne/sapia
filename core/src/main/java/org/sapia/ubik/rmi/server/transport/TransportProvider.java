...
public interface TransportProvider {
   ...
   * 
   * @param props
   *          the {@link Properties} used to create the server.
   * @return a {@link Server} instance.
   */
  public Server newServer(Properties props) throws RemoteException;

  /**
   * This method is called by Ubik RMI's runtime when a server is needed on the
   * client side to recieve asynchronous responses (i.e.: callbacks).
   * Implementations must in this case provide a "default" {@link Server}
   * instance.
   * 
