...
public class StatelessStubEnrichmentStrategy implements StubEnrichmentStrategy {
   ...
   * proxy (created with Java's reflection API) wraps a
   ...
   *          returned.
   * @param domain
   *          the name of the domain to which the object "belongs".
   * @param obj
  ...
  public Object enrich(Object stub, JndiBindingInfo info) throws RemoteException {
    ...
    Object proxy = Proxy.newProxyInstance(Thread.currentThread().getContextClassLoader(),
        serverTable.getTypeCache().getInterfaceArrayFor(exported.getClass()), stateless);
    return proxy;
  }
