...
/**
 * An instance of this class sends a RMI method command (see {@link InvokeCommand}) over the wire to the appropriate endpoint.
 * It handles callbacks, whereby the method call's return value is expected to be sent asynchronously. In such a case,
 * the {@link #dispatchInvocation(InvocationStats, Connections, InvokeCommand)} method will block on the client side 
 * until the return value is received, or until a given timeout is reached.
 * 
...
public class RemoteInvocationStrategy implements InvocationStrategy {
  ...
  @Override
  public Object dispatchInvocation(InvocationStats perf, Connections pool, InvokeCommand cmd) 
  ...
  private Object doDispatchInvocation(InvocationStats perf, Connections pool, InvokeCommand cmd) 
    throws IOException, ClassNotFoundException, Throwable {
  ...
  private Object doDispatchCallbackInvocation(InvocationStats perf, Connections pool, CallbackInvokeCommand cmd) 
    throws IOException, ClassNotFoundException, Throwable {
