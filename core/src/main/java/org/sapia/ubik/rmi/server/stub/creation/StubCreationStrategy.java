...
public interface StubCreationStrategy extends StubStrategy {
  ...
  /**
   * @param exported
   *          the {@link Object} that has been exported (as a remote object).
   * @param handler
   *          the {@link StubInvocationHandler} that the stub to create should
   *          wrap.
   * @return <code>true</code> if this instance should be used to create the
   *         stub corresponding to the given parameters.
   */
   ...
   *          the {@link StubInvocationHandler} that the stub to create should
   *          wrap.
   * @param stubInterfaces
   *          the array of {@link Class} corresponding to the interfaces that
