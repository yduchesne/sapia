 ...
 * conditions occurring. It is not sent in response to a request, nor is a
 * response expected for it.
 * 
 * @author yduchesne
 * 
 */
public abstract class ControlNotification implements Externalizable, SplittableMessage {
  ...
  /**
   * @param targetedNodes
   *          the {@link Set} of identifiers of the nodes that are targeted by
   *          the notification.
   */
  ...
  /**
   * @return this instance's {@link Set} of identifiers of the nodes that are
   ...
   * subset of the original targeted notes.
   * 
