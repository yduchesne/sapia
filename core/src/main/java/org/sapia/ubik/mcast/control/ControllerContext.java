...
public class ControllerContext {
   ...
   * 
   * @param the
   *          {@link EventChannelController} to which this instance corresponds.
   * @param callback
   *          the {@link ChannelCallback} corresponding to the
  ...
  /**
   * @return the time (in millis) at which the last heartbeat request was
   *         received.
   */
  ...
  /**
   * Internally updates the time at which the last heartbeat request was
   * received.
   * 
  ...
  /**
   * @return the time (in millis) at which the last challenge request was
   *         triggered.
   */
  ...
  /**
   * Internally updates the time at which the last challenge request was
   * received.
   * 
   * @see #lastChallengeReqSentTime.
   */
   ...
   * 
   * @param listener
   *          an {@link EventChannelControllerListener} to add to this instance.
   */
  ...
  /**
   * @param listener
   *          an {@link EventChannelControllerListener} to remove from this
   *          instance.
   */
  ...
  /**
   * @return the ID of the node that is currently the master (will be
   *         <code>null</code> if no heartbeat request has yet been received).
   */
