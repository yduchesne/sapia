...
// --------------------------------
import org.sapia.domain.dublincore.Identifier;
 ...
 * @version 1.0
 */
public class IdentifierHandlerState extends AbstractDublinCoreHandlerState {
  /////////////////////////////////////////////////////////////////////////////////////////
  /////////////////////////////////  INSTANCE ATTRIBUTES  /////////////////////////////////
  /////////////////////////////////////////////////////////////////////////////////////////
  ...
  private Identifier _theIdentifier;
  ...
  /**
   * Creates a new IdentifierHandlerState instance.
   */
  public IdentifierHandlerState() {
    _isParsing           = false;
  ...
  public void startElement(HandlerContextIF aContext, String anUri,
    ...
    if (ELEMENT_IDENTIFIER.equals(aLocalName)) {
      _isParsing = true;

      String anXmlLanguageCode = ParserUtil.extractXmlLanguageCode(someAttributes);
      _theIdentifier = new Identifier("", anXmlLanguageCode);
    }
  }
  ...
  public void endElement(HandlerContextIF aContext, String anUri,
    ...
    if (ELEMENT_IDENTIFIER.equals(aLocalName)) {
      _theIdentifier.setValue(_theElementContent.toString());
      _isParsing = false;
    }
  }
