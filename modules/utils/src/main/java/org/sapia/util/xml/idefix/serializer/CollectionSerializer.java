 ...
 * </dl>
 */
public class CollectionSerializer implements SerializerIF {
  /**
  ...
  public void serialize(Object aCollection, Namespace aNamespace,
    ...
    try {
      ...
      for (Iterator it = ((Collection) aCollection).iterator(); it.hasNext();) {
        anObject = it.next();
