...
// --------------------------------
import org.sapia.domain.dublincore.parser.RelationHandlerState;
 ...
 * @version 1.0
 */
public class RelationHandlerStateTest extends TestCase {
  ...
  private static final String ELEMENT_VALUE = "Tester";
  ...
  private static final String INVALID_NAMESPACE_ELEMENT =
      "<dc:relation xmlns:dc=\"http://another.org/dc/elements/1.1/\">" +
          ELEMENT_VALUE +
      "</dc:relation>";

  /** Defines the a unqualified xml:lang valid test case. */
  private static final String UNQUALIFIED_XMLLANG_VALID_ELEMENT =
      "<dc:relation xmlns:dc=\"http://purl.org/dc/elements/1.1/\" xml:lang=\"en-US\">" +
          ELEMENT_VALUE +
      "</dc:relation>";
  ...
  private static final String QUALIFIED_XMLLANG_VALID_ELEMENT =
      "<dc:relation xmlns:x=\"http://www.w3.org/XML/1998/namespace\" xmlns:dc=\"http://purl.org/dc/elements/1.1/\" x:lang=\"en-US\">" +
          ELEMENT_VALUE +
      "</dc:relation>";
  ...
  public static void main(String[] args) {
    TestRunner.run(RelationHandlerStateTest.class);
  }

  private RelationHandlerState _theHandlerState;
  private StatefullSAXHandler _theSAXHandler;

  /**
   * Creates a new RelationHandlerStateTest instance for the
   * test case name passed in.
   */
  public RelationHandlerStateTest(String aName) {
    super(aName);
  }
  ...
  public void setUp() {
    ...
    _theHandlerState = new RelationHandlerState();
  ...
  public void testUnqualifiedValidElement() throws Exception {
    ...
    assertNotNull("The result of the RelationHandlerState should not be null", _theHandlerState.getResult());
    assertEquals("The value of the Relation object is invalid", ELEMENT_VALUE, _theHandlerState.getResult().getValue());
