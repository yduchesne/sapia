...
// --------------------------------
import org.sapia.domain.dublincore.parser.CoverageHandlerState;
 ...
 * @version 1.0
 */
public class CoverageHandlerStateTest extends TestCase {
  ...
  private static final String ELEMENT_VALUE = "eXtendable Markup Language";
  ...
  private static final String INVALID_NAMESPACE_ELEMENT =
      "<dc:coverage xmlns:dc=\"http://another.org/dc/elements/1.1/\">" +
          ELEMENT_VALUE +
      "</dc:coverage>";

  /** Defines the a unqualified xml:lang valid test case. */
  private static final String UNQUALIFIED_XMLLANG_VALID_ELEMENT =
      "<dc:coverage xmlns:dc=\"http://purl.org/dc/elements/1.1/\" xml:lang=\"en-US\">" +
          ELEMENT_VALUE +
      "</dc:coverage>";
  ...
  private static final String QUALIFIED_XMLLANG_VALID_ELEMENT =
      "<dc:coverage xmlns:x=\"http://www.w3.org/XML/1998/namespace\" xmlns:dc=\"http://purl.org/dc/elements/1.1/\" x:lang=\"en-US\">" +
          ELEMENT_VALUE +
      "</dc:coverage>";
  ...
  public static void main(String[] args) {
    TestRunner.run(CoverageHandlerStateTest.class);
  }

  private CoverageHandlerState _theHandlerState;
  private StatefullSAXHandler _theSAXHandler;

  /**
   * Creates a new CoverageHandlerStateTest instance for the
   * test case name passed in.
   */
  public CoverageHandlerStateTest(String aName) {
    super(aName);
  }
  ...
  public void setUp() {
    ...
    _theHandlerState = new CoverageHandlerState();
  ...
  public void testUnqualifiedValidElement() throws Exception {
    ...
    assertNotNull("The result of the CoverageHandlerState should not be null", _theHandlerState.getResult());
    assertEquals("The value of the Coverage object is invalid", ELEMENT_VALUE, _theHandlerState.getResult().getValue());
