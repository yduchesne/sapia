...
// --------------------------------
import org.sapia.domain.dublincore.parser.RightsHandlerState;
 ...
 * @version 1.0
 */
public class RightsHandlerStateTest extends TestCase {
  ...
  private static final String ELEMENT_VALUE = "GNU General Public License";
  ...
  private static final String INVALID_NAMESPACE_ELEMENT =
      "<dc:rights xmlns:dc=\"http://another.org/dc/elements/1.1/\">" +
          ELEMENT_VALUE +
      "</dc:rights>";

  /** Defines the a unqualified xml:lang valid test case. */
  private static final String UNQUALIFIED_XMLLANG_VALID_ELEMENT =
      "<dc:rights xmlns:dc=\"http://purl.org/dc/elements/1.1/\" xml:lang=\"en-US\">" +
          ELEMENT_VALUE +
      "</dc:rights>";
  ...
  private static final String QUALIFIED_XMLLANG_VALID_ELEMENT =
      "<dc:rights xmlns:x=\"http://www.w3.org/XML/1998/namespace\" xmlns:dc=\"http://purl.org/dc/elements/1.1/\" x:lang=\"en-US\">" +
          ELEMENT_VALUE +
      "</dc:rights>";
  ...
  public static void main(String[] args) {
    TestRunner.run(RightsHandlerStateTest.class);
  }

  private RightsHandlerState _theHandlerState;
  private StatefullSAXHandler _theSAXHandler;

  /**
   * Creates a new RightsHandlerStateTest instance for the
   * test case name passed in.
   */
  public RightsHandlerStateTest(String aName) {
    super(aName);
  }
  ...
  public void setUp() {
    ...
    _theHandlerState = new RightsHandlerState();
  ...
  public void testUnqualifiedValidElement() throws Exception {
    ...
    assertNotNull("The result of the RightsHandlerState should not be null", _theHandlerState.getResult());
    assertEquals("The value of the Rights object is invalid", ELEMENT_VALUE, _theHandlerState.getResult().getValue());
