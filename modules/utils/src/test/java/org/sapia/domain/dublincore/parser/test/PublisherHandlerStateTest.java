...
// --------------------------------
import org.sapia.domain.dublincore.parser.PublisherHandlerState;
 ...
 * @version 1.0
 */
public class PublisherHandlerStateTest extends TestCase {
  ...
  private static final String ELEMENT_VALUE = "Addison-Wesley";
  ...
  private static final String INVALID_NAMESPACE_ELEMENT =
      "<dc:publisher xmlns:dc=\"http://another.org/dc/elements/1.1/\">" +
          ELEMENT_VALUE +
      "</dc:publisher>";

  /** Defines the a unqualified xml:lang valid test case. */
  private static final String UNQUALIFIED_XMLLANG_VALID_ELEMENT =
      "<dc:publisher xmlns:dc=\"http://purl.org/dc/elements/1.1/\" xml:lang=\"en-US\">" +
          ELEMENT_VALUE +
      "</dc:publisher>";
  ...
  private static final String QUALIFIED_XMLLANG_VALID_ELEMENT =
      "<dc:publisher xmlns:x=\"http://www.w3.org/XML/1998/namespace\" xmlns:dc=\"http://purl.org/dc/elements/1.1/\" x:lang=\"en-US\">" +
          ELEMENT_VALUE +
      "</dc:publisher>";
  ...
  public static void main(String[] args) {
    TestRunner.run(PublisherHandlerStateTest.class);
  }

  private PublisherHandlerState _theHandlerState;
  private StatefullSAXHandler _theSAXHandler;

  /**
   * Creates a new PublisherHandlerStateTest instance for the
   * test case name passed in.
   */
  public PublisherHandlerStateTest(String aName) {
    super(aName);
  }
  ...
  public void setUp() {
    ...
    _theHandlerState = new PublisherHandlerState();
  ...
  public void testUnqualifiedValidElement() throws Exception {
    ...
    assertNotNull("The result of the PublisherHandlerState should not be null", _theHandlerState.getResult());
    assertEquals("The value of the Publisher object is invalid", ELEMENT_VALUE, _theHandlerState.getResult().getValue());
