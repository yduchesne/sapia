...
// --------------------------------
import org.sapia.domain.dublincore.parser.CreatorHandlerState;
 ...
 * @version 1.0
 */
public class CreatorHandlerStateTest extends TestCase {
  ...
  private static final String INVALID_NAMESPACE_ELEMENT =
      "<dc:creator xmlns:dc=\"http://another.org/dc/elements/1.1/\">" +
          ELEMENT_VALUE +
      "</dc:creator>";

  /** Defines the a unqualified xml:lang valid test case. */
  private static final String UNQUALIFIED_XMLLANG_VALID_ELEMENT =
      "<dc:creator xmlns:dc=\"http://purl.org/dc/elements/1.1/\" xml:lang=\"en-US\">" +
          ELEMENT_VALUE +
      "</dc:creator>";
  ...
  private static final String QUALIFIED_XMLLANG_VALID_ELEMENT =
      "<dc:creator xmlns:x=\"http://www.w3.org/XML/1998/namespace\" xmlns:dc=\"http://purl.org/dc/elements/1.1/\" x:lang=\"en-US\">" +
          ELEMENT_VALUE +
      "</dc:creator>";
  ...
  public static void main(String[] args) {
    TestRunner.run(CreatorHandlerStateTest.class);
  }

  private CreatorHandlerState _theHandlerState;
  private StatefullSAXHandler _theSAXHandler;

  /**
   * Creates a new CreatorHandlerStateTest instance for the
   * test case name passed in.
   */
  public CreatorHandlerStateTest(String aName) {
    super(aName);
  }
  ...
  public void setUp() {
    ...
    _theHandlerState = new CreatorHandlerState();
  ...
  public void testUnqualifiedValidElement() throws Exception {
    ...
    assertNotNull("The result of the CreatorHandlerState should not be null", _theHandlerState.getResult());
    assertEquals("The value of the Creator object is invalid", ELEMENT_VALUE, _theHandlerState.getResult().getValue());
