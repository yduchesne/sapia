 ...
 * </dl>
 */
public class IteratorCursorFeedTest extends TestCase{
  
  public IteratorCursorFeedTest(String name){
    super(name);
  }
  ...
  public void testRead() throws Exception{
    ...
    IteratorCursorFeed feed = new IteratorCursorFeed(items.iterator());
    int total = 1;
    for(int i = 1; i <= 3; i++){
