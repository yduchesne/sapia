 ...
 * </dl>
 */
public class JDOMProcessorSingleTest extends TestCase {
  ...
  public static void main(String[] args) {
    TestRunner.run(JDOMProcessorSingleTest.class);
  }

  public JDOMProcessorSingleTest(String aName) {
    super(aName);
  }
  ...
  public void testGenericValue() throws Exception {
    ...
    assertEquals("The value of the generic object is invalid", "generic", aGenericObject.getValue());
  }
