...
/**
 * <p>
 * <b>The code from this class has beed copied from Jakarta's FileUploadBase
 * class and adapted to Cocoon's HttpRequest class. </b>
 * </p>
 * 
 * <p>
 ...
 * @author Yanick Duchesne (Sapia Open Source)
 * 
 * <dl>
 * <dt><b>Copyright: </b>
 ...
 * </dl>
 */
public abstract class CocoonFileUploadBase {
  // ----------------------------------------------------- Manifest constants
   ...
   *         otherwise.
   */
  public static final boolean isMultipartContent(HttpRequest req) {
   ...
   *              files.
   */
  public List /* FileItem */parseRequest(HttpRequest req)
