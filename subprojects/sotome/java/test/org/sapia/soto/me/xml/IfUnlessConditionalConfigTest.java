 ...
 */
public class IfUnlessConditionalConfigTest extends TestCase {
  ...
  public void testProcessing_local() throws Exception {
    ...
    _sotoMe.load("/org/sapia/soto/me/xml/IfUnlessConditionalConfig.soto.xml");
    _sotoMe.start();
  ...
  public void testProcessing_dev() throws Exception {
    ...
    _sotoMe.load("/org/sapia/soto/me/xml/IfUnlessConditionalConfig.soto.xml");
    _sotoMe.start();
    assertNotNull(_sotoMe.lookupService("helloWorld_notLocal"));
