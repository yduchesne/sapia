...
public class ModuleContainer {
   ...
   * 
   * @param moduleClass
   *          the class or interface under which to bind the given module.
   * @param module
   *          the {@link Module} to bind.
   * @throws ModuleAlreadyBoundException
   *           if a module has already been bound under the given name.
   ...
   * 
   * @param name
   *          the name of the module, which must be unique in the context of
   *          this instance.
   * @param module
   *          the {@link Module} to bind.
   * @throws ModuleAlreadyBoundException
   ...
   *          the {@link Module} to bind.
   * @throws ModuleAlreadyBoundException
   *           if the module has already been bound.
   * @return this instance.
   */
  ...
  /**
   * @param <T>
   *          the generic type of the module.
   * @param moduleClass
   *          the class of the module to look for.
   * @return the module that was found.
   * @throws ModuleNotFoundException
   *           if no such module was found.
   */
   ...
   *          the generic type of the module.
   * @param moduleClass
   *          the class or interface to internally cast the module to.
   * @param name
   ...
   * 
   * @param name
   *          the bean's {@link ObjectName}.
   * @param mbean
   *          the MBean {@link Object}
   */
