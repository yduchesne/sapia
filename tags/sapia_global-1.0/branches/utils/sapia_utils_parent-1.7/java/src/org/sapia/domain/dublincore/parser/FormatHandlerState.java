...
// --------------------------------
import org.sapia.domain.dublincore.Format;
 ...
 * @version 1.0
 */
public class FormatHandlerState extends AbstractDublinCoreHandlerState {
  /////////////////////////////////////////////////////////////////////////////////////////
  /////////////////////////////////  INSTANCE ATTRIBUTES  /////////////////////////////////
  /////////////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Creates a new FormatHandlerState instance.
   */
  public FormatHandlerState() {
    _isParsing           = false;
  ...
  public void startElement(HandlerContextIF aContext, String anUri,
    ...
    if (ELEMENT_FORMAT.equals(aLocalName)) {
      _isParsing = true;

      String anXmlLanguageCode = ParserUtil.extractXmlLanguageCode(someAttributes);
      _theFormat = new Format("", anXmlLanguageCode);
    }
  }
  ...
  public void endElement(HandlerContextIF aContext, String anUri,
    ...
    if (ELEMENT_FORMAT.equals(aLocalName)) {
      _theFormat.setValue(_theElementContent.toString());
      _isParsing = false;
    }
  }
