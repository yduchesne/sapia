...
// --------------------------------
import org.sapia.domain.dublincore.Subject;
 ...
 * @version 1.0
 */
public class SubjectHandlerState extends AbstractDublinCoreHandlerState {
  /////////////////////////////////////////////////////////////////////////////////////////
  /////////////////////////////////  INSTANCE ATTRIBUTES  /////////////////////////////////
  /////////////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Creates a new SubjectHandlerState instance.
   */
  public SubjectHandlerState() {
    _isParsing           = false;
  ...
  public void startElement(HandlerContextIF aContext, String anUri,
    ...
    if (ELEMENT_SUBJECT.equals(aLocalName)) {
      _isParsing = true;

      String anXmlLanguageCode = ParserUtil.extractXmlLanguageCode(someAttributes);
      _theSubject = new Subject("", anXmlLanguageCode);
    }
  }
  ...
  public void endElement(HandlerContextIF aContext, String anUri,
    ...
    if (ELEMENT_SUBJECT.equals(aLocalName)) {
      _theSubject.setValue(_theElementContent.toString());
      _isParsing = false;
    }
  }
