...
// --------------------------------
import org.sapia.domain.dublincore.parser.SubjectHandlerState;
 ...
 * @version 1.0
 */
public class SubjectHandlerStateTest extends TestCase {
  ...
  private static final String ELEMENT_VALUE = "Unit Test Automation";
  ...
  private static final String INVALID_NAMESPACE_ELEMENT =
      "<dc:subject xmlns:dc=\"http://another.org/dc/elements/1.1/\">" +
          ELEMENT_VALUE +
      "</dc:subject>";

  /** Defines the a unqualified xml:lang valid test case. */
  private static final String UNQUALIFIED_XMLLANG_VALID_ELEMENT =
      "<dc:subject xmlns:dc=\"http://purl.org/dc/elements/1.1/\" xml:lang=\"en-US\">" +
          ELEMENT_VALUE +
      "</dc:subject>";
  ...
  private static final String QUALIFIED_XMLLANG_VALID_ELEMENT =
      "<dc:subject xmlns:x=\"http://www.w3.org/XML/1998/namespace\" xmlns:dc=\"http://purl.org/dc/elements/1.1/\" x:lang=\"en-US\">" +
          ELEMENT_VALUE +
      "</dc:subject>";
  ...
  public static void main(String[] args) {
    TestRunner.run(SubjectHandlerStateTest.class);
  }

  private SubjectHandlerState _theHandlerState;
  private StatefullSAXHandler _theSAXHandler;

  /**
   * Creates a new SubjectHandlerStateTest instance for the
   * test case name passed in.
   */
  public SubjectHandlerStateTest(String aName) {
    super(aName);
  }
  ...
  public void setUp() {
    ...
    _theHandlerState = new SubjectHandlerState();
  ...
  public void testUnqualifiedValidElement() throws Exception {
    ...
    assertNotNull("The result of the SubjectHandlerState should not be null", _theHandlerState.getResult());
    assertEquals("The value of the Subject object is invalid", ELEMENT_VALUE, _theHandlerState.getResult().getValue());
