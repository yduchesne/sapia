...
/**
 * An instance of this class provides an indirection to the
...
public interface ModuleContext {
  ...
  /**
   * Holds constants corresponding to the {@link ModuleContainer}'s different
   * possible states.
   */
  public enum State {
   ...
   * 
   * @param <T>
   *          the generic type of the module to lookup.
   * @param type
   *          the module {@link Class}.
   * @return the object that was looked up.
   * @throws ModuleNotFoundException
   *           if no such module could be found.
   */
