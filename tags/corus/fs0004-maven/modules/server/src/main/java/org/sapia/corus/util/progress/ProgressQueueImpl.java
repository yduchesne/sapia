...
public class ProgressQueueImpl implements ProgressQueue {
  ...
  /**
   * @see org.sapia.corus.util.progress.ProgressQueue#hasNext()
   */
  ...
  /**
   * @see org.sapia.corus.util.progress.ProgressQueue#next()
   */
  ...
  /**
   * @see org.sapia.corus.util.progress.ProgressQueue#fetchNext()
   */
  ...
  /**
   * @see org.sapia.corus.util.progress.ProgressQueue#addMsg(org.sapia.corus.util.progress.ProgressMsg)
   */
  ...
  /**
   * @see org.sapia.corus.util.progress.ProgressQueue#close()
   */
  ...
  /**
   * 
   * @see org.sapia.corus.util.progress.ProgressQueue#isClosed()
   */
  ...
  /**
   * @see org.sapia.corus.util.progress.ProgressQueue#debug(Object)
   */
  ...
  /**
   * @see org.sapia.corus.util.progress.ProgressQueue#verbose(Object)
   */
  ...
  /**
   * @see org.sapia.corus.util.progress.ProgressQueue#error(Object)
   */
  ...
  /**
   * @see org.sapia.corus.util.progress.ProgressQueue#warning(Object)
   */
