...
class ResponseSenderFactoryImpl implements ResponseSenderFactory {
   ...
   * @param queue the {@link CallbackResponseQueue} that is used to internally create the {@link ColocatedResponseSender}.
   */
  ...
  /**
   * @param destination the {@link Destination} for which to return a {@link ResponseSender}.
   * @return the {@link ResponseSender} that is appropriate for th given {@link Destination}.
   */
