...
public class NamedThreadFactory implements ThreadFactory {
  ...
  /**
   * Specifies the behavior for providing thread names to a
  ...
  /**
   * @param daemon
   *          indicates if this instance should create daemon threads (
  ...
  /**
   * @param group
   *          the {@link ThreadGroup} to which the threads that this instance
   *          creates should belong.
   * @return this instance.
   */
  ...
  /**
   * @param priority
   *          the priority to assign to the threads that are created.
   * @return this instance.
   */
  ...
  /**
   * Creates a new thread, named according to this instance's
   * {@link ThreadNameStrategy}.
   */
  ...
  /**
   * Internally creates a {@link DefaultThreadNameStrategy} with the given base
   * name. The strategy is passed to the returned factory.
   * 
   * @param baseName
   *          the base name to use when creating threads.
