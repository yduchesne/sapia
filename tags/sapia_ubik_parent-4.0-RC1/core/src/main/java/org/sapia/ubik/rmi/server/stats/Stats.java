...
public class Stats {
  ...
  /**
   * @param source
   *          the name of the instance owning the {@link Stopwatch}.
   * @param name
   *          a name.
   * @param desc
   *          a description.
  ...
  /**
   * @param source
   *          the {@link Class} of the instance owning the {@link Stopwatch}.
   * @param name
   *          a name.
   * @param desc
   *          a description.
  ...
  /**
   * @param source
   *          the name of the instance owing the counter.
   * @param name
   *          a name.
   * @param desc
   *          a description.
  ...
  /**
   * @param source
   *          the {@link Class} of the instance owning the counter.
   * @param name
   *          a name.
   * @param desc
   *          a description.
  ...
  /**
   * @param stat
   *          a {@link Simon} instance, corresponding to a statistic whose
  ...
  /**
   * @param stat
   *          a {@link Simon} instance, corresponding to a statistic to reset.
   */
  ...
  /**
   * @return the {@link List} of {@link Simon} instances corresponding to Ubik
   *         stats.
   */
