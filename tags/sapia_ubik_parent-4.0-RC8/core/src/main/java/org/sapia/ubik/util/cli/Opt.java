...
public class Opt {
  ...
  /**
   * @return this option's value, or <code>null</code> if none was specified (or
   *         if this instance's type if {@link Type#ARG}).
   */
  ...
  /**
   * @return an empty {@link String} if this instance's {@link #value} is
   *         <code>null</code>, or this instance's value with its heading and
   *         tailing whitespaces trimmed if it isn't <code>null</code>.
   */
