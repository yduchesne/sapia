...
public class ThreadStartup {
   ...
   * @throws Exception the startup exception, if this instance's {@link #failed(Exception)} method
   * was called.
   */
  ...
  /**
   * Sets this instance's {@link #started} flag to <code>true</code>, and notifies
   * waiting threads.
   */
  ...
  /**
   * @return <code>true</code> if this is instance's {@link #started} flag is set to <code>true</code>, false 
   * otherwise.
   */
  ...
  /**
   * Sets this instance's {@link #started} flag to <code>true</code>. Also
   * sets this instance' start exeption with the passed in exception. 
   * <p>
