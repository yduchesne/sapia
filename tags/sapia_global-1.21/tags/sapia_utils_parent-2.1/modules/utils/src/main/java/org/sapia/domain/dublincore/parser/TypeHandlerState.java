...
// --------------------------------
import org.sapia.domain.dublincore.Type;
 ...
 * @version 1.0
 */
public class TypeHandlerState extends AbstractDublinCoreHandlerState {
  /////////////////////////////////////////////////////////////////////////////////////////
  /////////////////////////////////  INSTANCE ATTRIBUTES  /////////////////////////////////
  /////////////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Creates a new TypeHandlerState instance.
   */
  public TypeHandlerState() {
    _isParsing           = false;
   ...
   *
   * @return The result Type object of this handler state.
   * @exception IllegalStateException If this handler state is currently parsing.
   */
  public Type getResult() {
    if (_isParsing == true) {
      throw new IllegalStateException(
        "This TypeHandlerState is currently parsing");
    }
  ...
  public void endElement(HandlerContextIF aContext, String anUri,
    ...
    if (ELEMENT_TYPE.equals(aLocalName)) {
      _theType.setValue(_theElementContent.toString());
      _isParsing = false;
    }
  }
