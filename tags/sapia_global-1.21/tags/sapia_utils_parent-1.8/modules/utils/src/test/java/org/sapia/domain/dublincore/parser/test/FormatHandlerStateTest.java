...
// --------------------------------
import org.sapia.domain.dublincore.parser.FormatHandlerState;
 ...
 * @version 1.0
 */
public class FormatHandlerStateTest extends TestCase {
  ...
  private static final String ELEMENT_VALUE = "text/xml";
  ...
  private static final String INVALID_NAMESPACE_ELEMENT =
      "<dc:format xmlns:dc=\"http://another.org/dc/elements/1.1/\">" +
          ELEMENT_VALUE +
      "</dc:format>";

  /** Defines the a unqualified xml:lang valid test case. */
  private static final String UNQUALIFIED_XMLLANG_VALID_ELEMENT =
      "<dc:format xmlns:dc=\"http://purl.org/dc/elements/1.1/\" xml:lang=\"en-US\">" +
          ELEMENT_VALUE +
      "</dc:format>";
  ...
  private static final String QUALIFIED_XMLLANG_VALID_ELEMENT =
      "<dc:format xmlns:x=\"http://www.w3.org/XML/1998/namespace\" xmlns:dc=\"http://purl.org/dc/elements/1.1/\" x:lang=\"en-US\">" +
          ELEMENT_VALUE +
      "</dc:format>";
  ...
  public static void main(String[] args) {
    TestRunner.run(FormatHandlerStateTest.class);
  }

  private FormatHandlerState _theHandlerState;
  private StatefullSAXHandler _theSAXHandler;

  /**
   * Creates a new FormatHandlerStateTest instance for the
   * test case name passed in.
   */
  public FormatHandlerStateTest(String aName) {
    super(aName);
  }
  ...
  public void setUp() {
    ...
    _theHandlerState = new FormatHandlerState();
  ...
  public void testUnqualifiedValidElement() throws Exception {
    ...
    assertNotNull("The result of the FormatHandlerState should not be null", _theHandlerState.getResult());
    assertEquals("The value of the Format object is invalid", ELEMENT_VALUE, _theHandlerState.getResult().getValue());
