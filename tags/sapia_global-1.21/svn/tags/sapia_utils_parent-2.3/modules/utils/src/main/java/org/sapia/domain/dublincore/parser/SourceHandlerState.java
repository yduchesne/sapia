...
// --------------------------------
import org.sapia.domain.dublincore.Source;
 ...
 * @version 1.0
 */
public class SourceHandlerState extends AbstractDublinCoreHandlerState {
  /////////////////////////////////////////////////////////////////////////////////////////
  /////////////////////////////////  INSTANCE ATTRIBUTES  /////////////////////////////////
  /////////////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Creates a new SourceHandlerState instance.
   */
  public SourceHandlerState() {
    _isParsing           = false;
  ...
  public void startElement(HandlerContextIF aContext, String anUri,
    ...
    if (ELEMENT_SOURCE.equals(aLocalName)) {
      _isParsing = true;

      String anXmlLanguageCode = ParserUtil.extractXmlLanguageCode(someAttributes);
      _theSource = new Source("", anXmlLanguageCode);
    }
  }
  ...
  public void endElement(HandlerContextIF aContext, String anUri,
    ...
    if (ELEMENT_SOURCE.equals(aLocalName)) {
      _theSource.setValue(_theElementContent.toString());
      _isParsing = false;
    }
  }
