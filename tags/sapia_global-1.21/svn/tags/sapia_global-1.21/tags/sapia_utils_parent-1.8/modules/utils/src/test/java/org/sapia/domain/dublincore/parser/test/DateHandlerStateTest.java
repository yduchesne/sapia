...
// --------------------------------
import org.sapia.domain.dublincore.parser.DateHandlerState;
 ...
 * @version 1.0
 */
public class DateHandlerStateTest extends TestCase {
  ...
  private static final String ELEMENT_VALUE = "2001-05-22";
  ...
  private static final String QUALIFIED_XMLLANG_VALID_ELEMENT =
      "<dc:date xmlns:x=\"http://www.w3.org/XML/1998/namespace\" xmlns:dc=\"http://purl.org/dc/elements/1.1/\" x:lang=\"en-US\">" +
          ELEMENT_VALUE +
      "</dc:date>";
  ...
  public static void main(String[] args) {
    TestRunner.run(DateHandlerStateTest.class);
  }

  private DateHandlerState _theHandlerState;
  private StatefullSAXHandler _theSAXHandler;

  /**
   * Creates a new DateHandlerStateTest instance for the
   * test case name passed in.
   */
  public DateHandlerStateTest(String aName) {
    super(aName);
  }
  ...
  public void setUp() {
    ...
    _theHandlerState = new DateHandlerState();
  ...
  public void testUnqualifiedValidElement() throws Exception {
    ...
    assertNotNull("The result of the DateHandlerState should not be null", _theHandlerState.getResult());
    assertEquals("The value of the Date object is invalid", ELEMENT_VALUE, _theHandlerState.getResult().getValue());
