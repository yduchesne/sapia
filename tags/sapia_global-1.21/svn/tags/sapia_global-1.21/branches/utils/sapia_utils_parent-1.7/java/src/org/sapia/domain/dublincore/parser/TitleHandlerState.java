...
// --------------------------------
import org.sapia.domain.dublincore.Title;
 ...
 * @version 1.0
 */
public class TitleHandlerState extends AbstractDublinCoreHandlerState {
  /////////////////////////////////////////////////////////////////////////////////////////
  /////////////////////////////////  INSTANCE ATTRIBUTES  /////////////////////////////////
  /////////////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Creates a new TitleHandlerState instance.
   */
  public TitleHandlerState() {
    _isParsing           = false;
  ...
  public void endElement(HandlerContextIF aContext, String anUri,
    ...
    if (ELEMENT_TITLE.equals(aLocalName)) {
      _theTitle.setValue(_theElementContent.toString());
      _isParsing = false;
    }
  }
