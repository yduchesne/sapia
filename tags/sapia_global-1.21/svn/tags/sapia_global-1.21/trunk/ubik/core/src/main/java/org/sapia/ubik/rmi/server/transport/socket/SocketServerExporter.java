...
/**
 * An instance of this class exports given objects as remote objects using the
 * {@link SocketTransportProvider}.
 * 
 * @author yduchesne
 * 
 */
public class SocketServerExporter {
  ...
  /**
   * @param maxThreads
   *          the maximum number of worker threads on the server side (note that
   *          the {@link SocketTransportProvider} will consult the
   *          {@link Consts#SERVER_MAX_THREADS} property first, and will use
  ...
  /**
   * @param bindAddress
   *          the address corresponding to the network interface to which the
   *          server should bind - defaults to all network interfaces if not
   *          set.
   * @return this instance.
   */
  ...
  /**
   * @param port
   *          the port on which the server should listen (defaults to a random
   *          port if not set).
   * @return this instance.
   */
   ...
   * @return the remote object corresponding to the stub resulting form the
   *         export.
   * @throws RemoteException
   *           if a problem occurred trying to export the given object.
   */
  ...
  /**
   * @param props
   *          the {@link Properties} instance to which any additional properties
   *          should be added.
   */
