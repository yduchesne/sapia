...
// --------------------------------
import org.sapia.domain.dublincore.parser.DescriptionHandlerState;
 ...
 * @version 1.0
 */
public class DescriptionHandlerStateTest extends TestCase {
  ...
  private static final String ELEMENT_VALUE = "This is a jUnit test case";
  ...
  private static final String INVALID_NAMESPACE_ELEMENT =
      "<dc:description xmlns:dc=\"http://another.org/dc/elements/1.1/\">" +
          ELEMENT_VALUE +
      "</dc:description>";

  /** Defines the a unqualified xml:lang valid test case. */
  private static final String UNQUALIFIED_XMLLANG_VALID_ELEMENT =
      "<dc:description xmlns:dc=\"http://purl.org/dc/elements/1.1/\" xml:lang=\"en-US\">" +
          ELEMENT_VALUE +
      "</dc:description>";
  ...
  private static final String QUALIFIED_XMLLANG_VALID_ELEMENT =
      "<dc:description xmlns:x=\"http://www.w3.org/XML/1998/namespace\" xmlns:dc=\"http://purl.org/dc/elements/1.1/\" x:lang=\"en-US\">" +
          ELEMENT_VALUE +
      "</dc:description>";
  ...
  public static void main(String[] args) {
    TestRunner.run(DescriptionHandlerStateTest.class);
  }

  private DescriptionHandlerState _theHandlerState;
  private StatefullSAXHandler _theSAXHandler;

  /**
   * Creates a new DescriptionHandlerStateTest instance for the
   * test case name passed in.
   */
  public DescriptionHandlerStateTest(String aName) {
    super(aName);
  }
  ...
  public void setUp() {
    ...
    _theHandlerState = new DescriptionHandlerState();
  ...
  public void testUnqualifiedValidElement() throws Exception {
    ...
    assertNotNull("The result of the DescriptionHandlerState should not be null", _theHandlerState.getResult());
    assertEquals("The value of the Description object is invalid", ELEMENT_VALUE, _theHandlerState.getResult().getValue());
