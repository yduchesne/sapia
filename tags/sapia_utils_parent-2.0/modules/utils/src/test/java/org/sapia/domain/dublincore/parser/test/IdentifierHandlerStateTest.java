...
// --------------------------------
import org.sapia.domain.dublincore.parser.IdentifierHandlerState;
 ...
 * @version 1.0
 */
public class IdentifierHandlerStateTest extends TestCase {
  ...
  private static final String ELEMENT_VALUE = "ISBN 0-201-48567-2";
  ...
  private static final String INVALID_NAMESPACE_ELEMENT =
      "<dc:identifier xmlns:dc=\"http://another.org/dc/elements/1.1/\">" +
          ELEMENT_VALUE +
      "</dc:identifier>";

  /** Defines the a unqualified xml:lang valid test case. */
  private static final String UNQUALIFIED_XMLLANG_VALID_ELEMENT =
      "<dc:identifier xmlns:dc=\"http://purl.org/dc/elements/1.1/\" xml:lang=\"en-US\">" +
          ELEMENT_VALUE +
      "</dc:identifier>";
  ...
  private static final String QUALIFIED_XMLLANG_VALID_ELEMENT =
      "<dc:identifier xmlns:x=\"http://www.w3.org/XML/1998/namespace\" xmlns:dc=\"http://purl.org/dc/elements/1.1/\" x:lang=\"en-US\">" +
          ELEMENT_VALUE +
      "</dc:identifier>";
  ...
  public static void main(String[] args) {
    TestRunner.run(IdentifierHandlerStateTest.class);
  }

  private IdentifierHandlerState _theHandlerState;
  private StatefullSAXHandler _theSAXHandler;

  /**
   * Creates a new IdentifierHandlerStateTest instance for the
   * test case name passed in.
   */
  public IdentifierHandlerStateTest(String aName) {
    super(aName);
  }
  ...
  public void setUp() {
    ...
    _theHandlerState = new IdentifierHandlerState();
  ...
  public void testUnqualifiedValidElement() throws Exception {
    ...
    assertNotNull("The result of the IdentifierHandlerState should not be null", _theHandlerState.getResult());
    assertEquals("The value of the Identifier object is invalid", ELEMENT_VALUE, _theHandlerState.getResult().getValue());
