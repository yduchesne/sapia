...
// --------------------------------
import org.sapia.domain.dublincore.parser.TitleHandlerState;
 ...
 * @version 1.0
 */
public class TitleHandlerStateTest extends TestCase {
  ...
  private static final String ELEMENT_VALUE = "Unit Testing of (DCOM) Dublin Core Object Model";
  ...
  private static final String INVALID_NAMESPACE_ELEMENT =
      "<dc:title xmlns:dc=\"http://another.org/dc/elements/1.1/\">" +
          ELEMENT_VALUE +
      "</dc:title>";

  /** Defines the a unqualified xml:lang valid test case. */
  private static final String UNQUALIFIED_XMLLANG_VALID_ELEMENT =
      "<dc:title xmlns:dc=\"http://purl.org/dc/elements/1.1/\" xml:lang=\"en-US\">" +
          ELEMENT_VALUE +
      "</dc:title>";
  ...
  private static final String QUALIFIED_XMLLANG_VALID_ELEMENT =
      "<dc:title xmlns:x=\"http://www.w3.org/XML/1998/namespace\" xmlns:dc=\"http://purl.org/dc/elements/1.1/\" x:lang=\"en-US\">" +
          ELEMENT_VALUE +
      "</dc:title>";
  ...
  public static void main(String[] args) {
    TestRunner.run(TitleHandlerStateTest.class);
  }

  private TitleHandlerState _theHandlerState;
  private StatefullSAXHandler _theSAXHandler;

  /**
   * Creates a new TitleHandlerStateTest instance for the
   * test case name passed in.
   */
  public TitleHandlerStateTest(String aName) {
    super(aName);
  }
  ...
  public void setUp() {
    ...
    _theHandlerState = new TitleHandlerState();
  ...
  public void testUnqualifiedValidElement() throws Exception {
    ...
    assertNotNull("The result of the TitleHandlerState should not be null", _theHandlerState.getResult());
    assertEquals("The value of the Title object is invalid", ELEMENT_VALUE, _theHandlerState.getResult().getValue());
