...
public interface NettyMcastConsts {
  ...
  /**
   * Corresponds to the
   * <code>ubik.rmi.transport.mcast.netty.server.io.core-threads</code>
   * property, used to specify the number of Netty core threads for the IO
   * processing thread pool on the server side (defaults to 1).
   */
  public static final String SERVER_IO_CORE_THREADS_KEY = "ubik.rmi.transport.mcast.netty.server.io.core-threads";

  /**
   * Corresponds to the
   * <code>ubik.rmi.transport.mcast.netty.server.io.max-threads</code> property,
   * used to specify the number of Netty max threads for the IO processing
   * thread pool on the server side (defaults to 5).
   */
  public static final String SERVER_IO_MAX_THREADS_KEY = "ubik.rmi.transport.mcast.netty.server.io.max-threads";

  /**
   * Corresponds to the
   * <code>ubik.rmi.transport.mcast.netty.server.io.queue-size</code> property,
   * used to specify the size of the blocking queue of the IO processing thread
   * pool on the server side (defaults to 50).
   */
  public static final String SERVER_IO_QUEUE_SIZE_KEY = "ubik.rmi.transport.mcast.netty.server.io.queue-size";

  /**
   * Corresponds to the
   * <code>ubik.rmi.transport.mcast.netty.server.io.keep-alive</code> property,
   * used to specify the keep-alive value (in seconds) of the IO processing
   * thread pool on the server side (defaults to 30 seconds).
   */
  public static final String SERVER_IO_KEEP_ALIVE_KEY = "ubik.rmi.transport.mcast.netty.server.io.keep-alive";

  /**
   * Corresponds to the
   * <code>ubik.rmi.transport.mcast.netty.server.worker.max-threads</code>
   * property, used to specify the number of Netty core threads for the worker
   * thread pool on the server side (defaults to 5).
   */
   ...
   * Corresponds to the
   * <code>ubik.rmi.transport.mcast.netty.server.worker.max-threads</code>
   * property, used to specify the number of Netty max threads for the worker
   * thread pool on the server side (defaults to 10).
   */
  public static final String SERVER_WORKER_MAX_THREADS_KEY = "ubik.rmi.transport.mcast.netty.server.worker.max-threads";

  /**
   * Corresponds to the
   * <code>ubik.rmi.transport.mcast.netty.server.worker.queue-size</code>
   * property, used to specify the number size of the blocking queue of the
   * "worker" thread pool on the client side (defaults to 100).
   */
  public static final String SERVER_WORKER_QUEUE_SIZE_KEY = "ubik.rmi.transport.mcast.netty.server.worker.queue-size";

  /**
   * Corresponds to the
   * <code>ubik.rmi.transport.mcast.netty.server.worker.keep-alive</code>
   * property, used to specify the keep-alive value (in seconds) of the "worker"
   * thread pool on the client side (defaults to 30 seconds).
   */
   ...
   * <code>ubik.rmi.transport.mcast.netty.server.bind-address</code> system
   * property.
   */
  ...
  /**
   * This constant corresponds to the
   * <code>ubik.rmi.transport.mcast.netty.server.port</code> system property.
   */
