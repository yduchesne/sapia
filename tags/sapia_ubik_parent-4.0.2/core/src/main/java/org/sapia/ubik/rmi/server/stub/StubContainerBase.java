...
public class StubContainerBase implements StubContainer, HealthCheck {
  ...
  /**
   * Returns <code>true</code> if the connection to the remote server of the
   * stub that this instance wraps is still valid.
   * 
   * @throws RemoteException
   *           if a problem occurs performing the check; if such an error
   *           occurs, this instance should be treated as invalid.
   */
